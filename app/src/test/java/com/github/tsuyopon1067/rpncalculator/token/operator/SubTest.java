...
public class SubTest {
    ...
    public void testSubCalculation() {
        ...
        assertEquals(-44.44, result1.getValue(), 0.0001);
        ...
        assertEquals(69.12, result2.getValue(), 0.0001);
        ...
        assertEquals(-69.12, result3.getValue(), 0.0001);
        ...
        assertEquals(44.44, result4.getValue(), 0.0001);
    }
}